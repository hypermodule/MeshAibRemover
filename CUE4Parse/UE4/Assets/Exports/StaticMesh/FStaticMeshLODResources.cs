...
public class FStaticMeshLODResources
{
    ...
    public long AdjacencyIndexBufferStartOffset; // StaticMeshAibRemover
    public long AdjacencyIndexBufferEndOffset; // StaticMeshAibRemover
    ...
    public void SerializeBuffers(FArchive Ar)
    {
            ...
            !stripDataFlags.IsClassDataStripped((byte) EClassDataStripFlag.CDSF_AdjacencyData))
        {
            ...
            {
                AdjacencyIndexBufferStartOffset = Ar.Position; // StaticMeshAibRemover

                AdjacencyIndexBuffer = new FRawStaticIndexBuffer(Ar);

                AdjacencyIndexBufferEndOffset = Ar.Position; // StaticMeshAibRemover
            }
        }
